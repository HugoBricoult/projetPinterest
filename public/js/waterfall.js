...
window.addEventListener('DOMContentLoaded', function(e) {
    ...
    let waterfall = new Waterfall({ minBoxWidth: 200 });
...
;(function (root, factory) {
    ...
    let Waterfall = function(opts) {
        ...
        opts = opts || {};
        let containerSelector = opts.containerSelector || '.wf-container';
        let boxSelector = opts.boxSelector || '.wf-box';
        ...
        let images = this.container.querySelectorAll('img'), that = this;
        let clr;
